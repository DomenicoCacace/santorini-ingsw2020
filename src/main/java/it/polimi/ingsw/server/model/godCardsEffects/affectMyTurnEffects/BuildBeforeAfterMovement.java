package it.polimi.ingsw.server.model.godCardsEffects.affectMyTurnEffects;
 ...
 * <ul>
 *     <li>Play the turn as usual, following the {@link it.polimi.ingsw.server.model.rules.RuleSetBase}</li>
