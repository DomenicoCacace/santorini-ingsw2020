...
import it.polimi.ingsw.client.view.cli.console.graphics.components.ActiveItem;
import it.polimi.ingsw.client.view.cli.console.graphics.components.DetailPane;
import it.polimi.ingsw.client.view.cli.console.graphics.components.SimpleListItem;
...
public class ListPane extends ActiveItem implements KeyEventListener {
     ...
     */
    public ListPane(Window caller, CursorPosition initCoord, int width, int height, Map<String, List<String>> options) {
        super(caller, initCoord, width, height);
        ...
        detailPane = new DetailPane(this, width, height);
