...
import it.polimi.ingsw.client.view.cli.console.graphics.components.ReturningListItem;
...
public class SingleChoiceListPane extends ActiveItem {
     ...
     */
    public SingleChoiceListPane(WindowItem parent, CursorPosition initCoord, int width, int height, List<String> options) {
